 ...
 * generated in the com.rl.ecps.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _PublishItem_QNAME = new QName("http://service.ws.ecps.rl.com/", "publishItem");
    private final static QName _PublishItemResponse_QNAME = new QName("http://service.ws.ecps.rl.com/", "publishItemResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rl.ecps.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.rl.com/", name = "publishItem")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.rl.com/", name = "publishItemResponse")
