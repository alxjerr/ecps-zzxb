	...
	<div class="r wr">
		...
		<div class="product">
        	<h2>${item.itemName }<span class="gray f14">${item.promotion }</span></h2>
 			<div class="showPro">
				<div class="big">
					<a id="showImg" class="cloud-zoom" href="${file_path }${item.imgs}" rel="adjustX:10,adjustY:-1">
						<img title="optional title display" alt="" src="${file_path }${item.imgs}">
					</a>
				</div>
				<div class="small">
			...
			<form method="post" action="" name="" class="infor">
				...
				<li>
					<label>移 动 价：</label>
					<span class="word">
						<b  id="skuPrice" class="f14 red mr">￥3999.00</b>(市场价:<del id="marketPrice">￥5789.00</del>)
					</span>
				</li>
				...
				<div class="box_orange">
					<ul class="uls form">
						...
						<li class="submit">
							<input type="button" id="buyNow" value="" class="hand btn138x40" onclick="buy();"/>
							<input type="button" id="addMyCart" value="" class="hand btn138x40b" onclick="addCart()"/>
		...
		<h2 class="h2 h2_ch mt"><em>
			...
			<a href="javascript:void(0);" title="包装信息" rel="#detailTab3">包装信息</a></em><cite></cite>
		</h2>
