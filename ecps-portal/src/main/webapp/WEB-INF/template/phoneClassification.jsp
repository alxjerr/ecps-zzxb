	...
	<div class="bg_gray mt ofc">
			...
			<ul class="uls i_150x150 x4_150x150b">
				<c:forEach items="${itemList }" var="item">
					<li>
						 <a href="${path }/html/${item.itemId}.html" title="张同来" target="_blank" class="pic"><img src="${file_path }${item.imgs}" alt="摩托罗拉XT319" /></a>
						<%--<a href="${path }/item/productDetail.do?itemId=${item.itemId }" title="张同来" target="_blank" class="pic"><img src="${file_path }${item.imgs}" alt="摩托罗拉XT319" /></a> --%>
						<dl>
							<!-- dt 10个文字+... -->
							<dt><a href="${path }/html/${item.itemId}.html" title="摩托罗拉XT319" target="_blank">${item.itemName }</a></dt>
							<!-- dt 25个文字+... -->
