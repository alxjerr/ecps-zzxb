		...
		<form id="jvForm" action="${path }/user/login.do" method="post">
			<ul class="uls form">
				...
				<li><label for="captcha">验证码：</label>
					...
					<img id="captchaImage" src="${path }/user/getImage.do" onclick="changeImage();" class="code" alt="换一张" />
					<a href="javascript:void(0);" onclick="changeImage();" title="换一张">换一张</a>
				</li>
