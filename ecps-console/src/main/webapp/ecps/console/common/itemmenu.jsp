...
<li><a href="${path}/item/listAuditItem.do?auditStatus=0&showStatus=1"><samp class="t05"></samp>商品审核</a></li>
...
<li><a href="${path}/item/selectBrandAll.do"><samp class="t05"></samp>品牌管理</a></li>
</ul>
